...
import com.door.match.paysdk.WXPayConstants.SignType;
...
public class WXPay {
     ...
     * @date 2018年8月20日
     */
    public Map<String, String> signRequestData(Map<String, String> reqData) throws Exception {
    	reqData.put("appid", config.getAppID());
        reqData.put("mch_id", config.getMchID());
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
        return reqData;
     ...
     * @date 2018年8月1日
     */
    public String signatureData(Map<String, String> reqData) throws Exception {
    	return  WXPayUtil.generateSignature(reqData, config.getKey());
    }
     ...
     * @date 2018年8月11日
     */
    public String signatureData(Map<String, String> reqData, SignType signType) throws Exception {
    	return  WXPayUtil.generateSignature(reqData, config.getKey(), signType);
    }
     ...
     * @Description: 签约支付
     */
    public Map<String, String> pappayappl(Map<String, String> reqData) throws Exception {
    	String respXml = this.requestWithCert(WXPayConstants.APIMCH_PAY_URL_SUFFIX, reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    	return this.processResponseXml(respXml);
    }
    ...
    public String jscode2session(String js_code, String authorization_code) throws Exception {
    	String url = WXPayConstants.SNS_JSCODE2SESSION_URL_SUFFIX
    			...
    			.replace("JSCODE", js_code).replace("authorization_code", authorization_code);
        return this.wxPayRequest.requestWithoutCert(url, null, null, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs(), autoReport);
    }
